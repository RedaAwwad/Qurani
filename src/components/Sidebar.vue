  ...
  <div class="fixed-sidebar" :class="{menu : menu}">
    <div class="menu_wraper">
      ...
      <div class="profile_controls">
        <a href="#login" class="btn_login modal-trigger">
          <span>تسجيل الدخول</span>
          <span class="btn_icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-in"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"></path><polyline points="10 17 15 12 10 7"></polyline><line x1="15" y1="12" x2="3" y2="12"></line></svg>
          </span>
        </a>
        <a href="#register" class="btn_login modal-trigger">
          <span>حساب جديد</span>
          <span class="btn_icon">
    ...
    <div class="footer">
      <small>
        Developed with 
        <svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 24 24" fill="red" stroke="red" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
...
<style lang="scss" scoped>
  ...
  .fixed-sidebar {
    ...
    z-index: 1;
    box-shadow: inset 3px 0 5px rgba(199, 199, 199, 0.45);
